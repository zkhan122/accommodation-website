...
## **To Run**:
1) Download the project zip file and extract contents inside root folder where laragon is located e.g. `C:\Users\___\laragon` and extract zip file contents inside the laragon www folder **change the extraction location from `"laragon\www\website"` to `"laragon\www\"`**  (by removing "website" directory from end to allow for laragon to direct to homepage directly to access website directly through `index.php`
